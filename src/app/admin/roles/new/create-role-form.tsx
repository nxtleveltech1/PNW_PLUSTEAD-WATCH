...
import { adminRoleCreateSchema, type AdminRoleCreateInput } from "@/lib/schemas";
...
export function CreateRoleForm({ allPermissions }: Props) {
  ...
  } = useForm<AdminRoleCreateInput>({
    resolver: zodResolver(adminRoleCreateSchema),
    defaultValues: {
      name: "",
      description: "",
      permissionKeys: [],
  ...
  async function onSubmit(data: AdminRoleCreateInput) {
