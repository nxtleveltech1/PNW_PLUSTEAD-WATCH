    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main id="main" className="page-main">
        <div className="page-hero">
          ...
          <h1 className="section-heading mt-2">Security of Information</h1>
        </div>
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">What information do we collect?</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">Who has access to my information?</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">Privacy setting</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">Concerns or questions</h2>
          <p>
