    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main id="main" className="page-main">
        <div className="page-hero">
          ...
          <h1 className="section-heading mt-2">Troubleshooting</h1>
        </div>
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">I&apos;m unable to sign in</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">Setting email and other preferences</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">The site doesn&apos;t remember me or I get logged off</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">I need more help</h2>
          <p>
