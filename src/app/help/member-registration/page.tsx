...
export default function MemberRegistrationHelpPage() {
  return (
    <PageShell>
      <PageHero eyebrow="Help" title="Member Registration" />
      <div className="prose prose-neutral mt-section max-w-none dark:prose-invert">
          ...
          <h2 className="font-display mt-8 text-xl font-semibold">Your details</h2>
          <p>
          ...
          <h2 className="font-display mt-8 text-xl font-semibold">Additional contact details</h2>
          <p>
          ...
          <h2 className="font-display mt-8 text-xl font-semibold">Patrolling</h2>
          <p>
          ...
          <h2 className="font-display mt-8 text-xl font-semibold">Email preferences</h2>
          <p>
          ...
          <h2 className="font-display mt-8 text-xl font-semibold">Finish</h2>
          <p>
