    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main id="main" className="page-main">
        <div className="page-hero">
          ...
          <h1 className="section-heading mt-2">Member FAQ</h1>
        </div>
        <div className="prose prose-neutral mt-8 max-w-none dark:prose-invert">
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">Who can register as a guest?</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">I forgot my password. What do I do?</h2>
          <p>
            On the sign-in page, use the &quot;Forgot password?&quot; link. You will receive an email with instructions to reset your password.
          </p>

          <h2 className="font-display mt-10 text-xl font-semibold">How do I update my details?</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">How do I report an incident?</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">My street is not in the list. Can I still register?</h2>
          <p>
          ...
          <h2 className="font-display mt-10 text-xl font-semibold">How long until my registration is approved?</h2>
          <p>
